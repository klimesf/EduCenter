...
class SystemContainer extends Nette\DI\Container
{
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=educenter', 'root', NULL, NULL);
